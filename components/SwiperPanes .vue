<template>
  <div class="tab-content w-100 pt-2">
    ...
    <div class="tab-pane">
      <!-- channel樣版 swiper -->
      <div v-swiper:mySwiper="swiperPanesOption" class="swiper-container" :class="panesTemplate">
        <div class="swiper-wrapper">
          <div v-for="inside in panesData" :key="inside.Voucher_Code" class="swiper-slide">
              ...
              <div class="products-content">
                <div class="products-img">
                  <div class="img-box">
                    <div
                      class="rwdimg-cover"
                      :style="{ backgroundImage: `url(${inside.Voucher_Image})` }"
                    />
                  </div>
                </div>
                <!-- 新聞 -->
